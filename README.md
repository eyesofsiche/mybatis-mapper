...
This project is a maintained fork of the original **mybatis-mapper** project.

The original repository has not been actively maintained for some time.
This fork focuses on bug fixes and stability improvements,
while preserving backward compatibility and the original design philosophy.
